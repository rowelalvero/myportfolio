...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "eea2c9b2-651a-467f-8b45-f61d3cb8e083");
  ...
  return (
    ...
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>Submit now
